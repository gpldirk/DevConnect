...
import { createOrUpdateProfile } from '../../redux/actions/profile'
import { getCurrentProfile } from '../../redux/actions/profile'

const ProfileForm = ({ history, createOrUpdateProfile, profile, getCurrentProfile }) => {
  ...
  return (
    <Fragment>
      <h1 className="large text-primary">
        {profile === null ? "Create" : "Update"} Your Profile
      </h1>
